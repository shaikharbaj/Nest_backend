...
export class BannerService {
    ...
    public async extract_public(url: string) {
        ...
        const publicID = match ? match[0].slice(1).split(".")[0] : null;
        return publicID;
    }
    ...
    async addBanner(file: Express.Multer.File, data: createBannerDTO, response: Response, auth: any) {
        try {
            ...
            return response.status(HttpStatus.OK).json({ success: true, message: "banner created successfully", data: savebanner })
        } catch (error) {
            return response.status(HttpStatus.BAD_REQUEST).json({ success: false, message: error.message })
        }
    }

    async getAllBanners(page: number, searchTerm: string, response: Response) {
        try {
            const select = {
                id: true,
                title: true,
            ...
            return response.status(HttpStatus.OK).json({ success: true, message: "banner fetch successfully", data })
        } catch (error) {
            return response.status(HttpStatus.BAD_REQUEST).json({ success: false, message: error.message })
        }
    }
    ...
    async getbannerbyId(id: number, response: Response) {
        try {
            ...
            return response.status(HttpStatus.OK).json({ success: true, message: "banner fetch successfully", data: banner })
        } catch (error) {
            return response.status(HttpStatus.BAD_REQUEST).json({ success: false, message: error.message })
        }
    }

    async updatebanner(file: any, data: any, id: number, response: Response) {
        try {
            ...
            return response.status(HttpStatus.OK).json({ success: true, message: "banner updated successfully", data: updatedbanner })
        } catch (error) {
            return response.status(HttpStatus.BAD_REQUEST).json({ success: false, message: error.message })
        }
    }
    ...
    async deletebanner(id: number, response: Response) {
        try {
            ...
            return response.status(HttpStatus.OK).json({ success: true, message: "banner deleted successfully", data: deletedbanner })
        } catch (error) {
            return response.status(HttpStatus.BAD_REQUEST).json({ success: false, message: error.message })
        }
    }
